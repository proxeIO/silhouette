import bpy
from bgl import glEnable, glLogicOp, glDisable, GL_COLOR_LOGIC_OP, GL_XOR, GL_COLOR_LOGIC_OP
...
def silhouette(self, context):
  ...
  handle = bpy.types.SpaceView3D.draw_handler_add(draw_handler, (self, context), 'WINDOW', 'PRE_VIEW')
